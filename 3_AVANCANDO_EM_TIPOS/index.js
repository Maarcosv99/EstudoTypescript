...
const arr1 = [1, "teste", true, [], { nome: "Marcos" }];
console.log(arr1);
arr1.push([1, 2, 3]);
console.log(arr1);
console.log('\n--------------------------------------------\n');
...
const somePerson = { name: "Marcos", age: 22 };
...
showDirection("left");
function showDirection2(direction) {
    console.log(`A direção é: ${direction}`);
}
